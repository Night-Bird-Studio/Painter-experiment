...
import 'package:paperless/core/data/app_configuration.dart';
import 'package:paperless/core/domain/exceptions.dart';
...
base class RemoteDataSource {
  ...
  Map<String, dynamic> _queryParameters(
    ...
    final apiQueryParameters = <String, dynamic>{};
  ...
  String _path(String endpoint) {
    final baseUrl = _baseUrl ?? configuration.apiBaseUrl;
